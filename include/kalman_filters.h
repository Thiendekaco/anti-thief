/**
 * Bộ lọc Kalman cho GPS và MPU6050
 *
 * Cung cấp các bộ lọc Kalman để lọc dữ liệu từ GPS và cảm biến gia tốc
 * nhằm giảm nhiễu và cải thiện độ chính xác của dữ liệu.
 *
 * Cập nhật lần cuối: 2025-06-19 09:31:11
...
/**
 * Bộ lọc Kalman cho GPS
 *
 * Lọc dữ liệu vị trí GPS (vĩ độ, kinh độ) để giảm nhiễu và cải thiện độ chính xác
 */
 ...
 *
 * Lọc dữ liệu gia tốc từ MPU6050 để giảm nhiễu và cải thiện phát hiện chuyển động
 */
